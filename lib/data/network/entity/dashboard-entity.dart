...
class WorkflowCountEntity {
  ...
  factory WorkflowCountEntity.fromJson(Map<String, dynamic> json) =>
      _$WorkflowCountEntityFromJson(json);

  Map<String, dynamic> toJson() => _$WorkflowCountEntityToJson(this);

  static List<WorkflowCountEntity> fromJsons(List data) =>
      List<WorkflowCountEntity>.from(
        data.map(
          (x) => WorkflowCountEntity.fromJson(x as Map<String, dynamic>),
        ),
      );
}

@JsonSerializable()
class ReferCountEntity {
  int sender;
  int receiver;
  ...
  factory ReferCountEntity.fromJson(Map<String, dynamic> json) =>
      _$ReferCountEntityFromJson(json);

  Map<String, dynamic> toJson() => _$ReferCountEntityToJson(this);
}
